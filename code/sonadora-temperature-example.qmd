...
sonadora_sum <- sonadora_clean |> 
  ...
  # calculate mean temperature at each elevation, round to one decimal
  summarize(mean_temp_c = round(mean(temp_c, na.rm = TRUE), 1)) |> 
...
#display 4 plots to interpret linearity
